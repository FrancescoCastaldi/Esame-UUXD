...
\definecolor{sectionBg}{HTML}{EBF0F7}
...
\begin{itemize}
  \item \textbf{Data:} 15-16 Giugno 2026
...
\vspace{0.3cm}
\noindent La checklist preventiva è una buona soluzione al problema ``arrivo allo sportello senza documenti'' (RF-35, RF-43).
\end{tcolorbox}
...
\vspace{0.3cm}
\noindent Banner ben progettato: visibile, targettizzato, con CTA chiara (RF-34, RF-36).
\end{tcolorbox}
...
\begin{tabular}{|L{3cm}|L{11cm}|}
\hline
\textbf{Azione utente} & \multicolumn{1}{L{11cm}|}{Su \texttt{agevolazioni.html} clicca ``Scopri le mie agevolazioni'' $\rightarrow$ risponde a 3 domande (età, residenza, frequenza viaggi) cliccando sulle opzioni.} \\
\hline
...
\vspace{0.3cm}
\noindent Wizard semplice, domande chiare, linguaggio non tecnico (RF-37). L'utente non deve conoscere termini burocratici per rispondere.
\end{tcolorbox}
...
\vspace{0.2cm}
\noindent\textbf{Issue identificata:} \textbf{CW-05 (Minore).} Il risultato non include un pulsante ``Stampa'' per portare la lista dei documenti allo sportello. Per l'utente anziano o a bassa competenza digitale, un supporto cartaceo è importante (RF-13).
...
\hline
\textbf{Q1 -- Goal} & Maria vuole ``comprare''. ``Dove Comprare'' corrisponde esattamente al suo bisogno. Per un'utente con competenza 1/5, il linguaggio ``Dove Comprare'' è perfetto. \\
\hline
...
\vspace{0.3cm}
\noindent``Dove Comprare'' è la scelta di labeling migliore per utenti con bassa competenza (RF-10, RF-17).
\end{tcolorbox}
...
\hline
\textbf{Q1 -- Goal} & L'obiettivo di Maria (comprare) non è realizzabile qui. Ma deve capire che la pagina la guiderà altrove. \\
\hline
...
\hline
\textbf{Q4 -- Feedback} & La pagina mostra subito il pulsante ``Ti aiutiamo a scegliere'' e le card dei canali. Maria ha opzioni visibili. \\
\hline
\end{tabular}
...
\hline
\textbf{Q1 -- Goal} & Maria capisce che la guida la porterà a un canale dove poter comprare. \\
\hline
\textbf{Q2 -- Visibility} & Il pulsante primario ``Ti aiutiamo a scegliere'' è ben visibile. Le opzioni sono grandi. \\
\hline
\textbf{Q3 -- Mapping} & ``Un biglietto (corsa singola o carnet)'' $\rightarrow$ Maria vuole ``un biglietto per l'autobus''. Mapping diretto. \\
\hline
...
\hline
CW-03 & \#2 Acquisto & \textbf{Media} & Sezione ``E adesso? Cosa fare dopo l'acquisto'' presente ma poco visibile (sotto la piega). L'utente potrebbe non vederla e salire a bordo senza titolo valido. RF-18, RF-28. \\
\hline
...
\begin{enumerate}[leftmargin=*]
  \item \textbf{Migliorare visibilità sezione post-acquisto (CW-03):} Spostare la sezione ``E adesso? Cosa fare dopo l'acquisto'' sopra la piega, in posizione prominente rispetto al riepilogo ordine, oppure replicarla come messaggio di conferma prima del download ricevuta. \textit{Corrisponde a RF-18, RF-28.}
  ...
  \item \textbf{Aggiungere stampa riepilogo (CW-05):} Aggiungere un pulsante ``Stampa'' nei risultati del wizard agevolazioni e nelle checklist documenti, per supportare il ponte analogico-digitale (RF-13).
