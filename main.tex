...
(progress bar) nei flussi di acquisto e rinnovo abbonamento su
\texttt{solweb.tper.it}, per orientare l'utente sul numero di passi residui.
...
pagina del flusso (\texttt{login.html}, \texttt{piani.html},
\texttt{documenti.html}, \texttt{pagamento.html}).
