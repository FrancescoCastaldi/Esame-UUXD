...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Blueprint/html/bp1-ia.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Blueprint/html/bp2-ecosystem.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{Blueprint/html/bp3-journey.png}
...
\textit{(This test relates to the final redesigned tool, Phase C --- v2.0)}
