...
% ================================================================
% WF7a: SOLWEB PAGAMENTO
% ================================================================
\section{Wireframe 7a: solweb --- Flusso di Pagamento}
\label{wf7a}

\begin{figure}[h!]
\centering
\wfgraphic{Wireframes/screenshot-wf7a.png}
\caption{solweb --- Pagamento con riepilogo carrello e metodo di pagamento}
\label{fig:wf7a}
\end{figure}

% ================================================================
% WF7b: SOLWEB CONFERMA
% ================================================================
\section{Wireframe 7b: solweb --- Conferma Post-Acquisto}
\label{wf7b}

\begin{figure}[h!]
\centering
\wfgraphic{Wireframes/screenshot-wf7b.png}
\caption{solweb --- Schermata di conferma con riepilogo e opzioni successive}
\label{fig:wf7b}
\end{figure}
...
\hline
WF1 & Homepage Guest & Route planner, 6 card servizio (Pianifica, Dove Comprare, Biglietti, Abbonamenti, Aiuto, Orari e Linee), sidebar Dove Comprare & Nav tabs, hero search, canali in sidebar, news, contatti \\
\hline
...
\hline
WF7a & solweb Pagamento & Riepilogo carrello, metodo di pagamento, form carta/dati & Flusso transazionale, breadcrumb, riepilogo importo \\
\hline
WF7b & solweb Conferma & Conferma acquisto, riepilogo ordine, opzioni successive & Biglietto/abbonamento acquistato, CTA stampa, dashboard \\
\hline
\end{tabular}
...
\begin{tcolorbox}[summarybox]
\small
\textbf{Nota:} Ogni issue \`e correlata ai requirement emersi dalla Phase A (R1--R13), dalla Phase B (Cast Card --- Use Case UR-01--UR-05) e dalla Phase D (Cognitive Walkthrough CW-01--CW-11, Formative Test FT1--FT7). Le soluzioni progettuali sono localizzabili nei wireframe (WF1--WF7b) e nei blueprint (BP1--BP3).
\end{tcolorbox}
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Wireframe:} 8 schermate (WF1--WF7b) che coprono l'intero ecosistema tper.it + solweb.
