...
\hline
WF1 & Homepage Guest & Route planner, 6 service cards (Pianifica, Dove Comprare, Biglietti, Abbonamenti, Aiuto, Orari e Linee), Dove Comprare sidebar & Nav tabs, hero search, channels in sidebar, news, contacts \\
\hline
...
\hline
WF7 & solweb: Payment + Confirmation & Cart summary, payment, purchase confirmation, next options & Transactional flow, purchased ticket/subscription, print CTA \\
\hline
\end{tabular}
