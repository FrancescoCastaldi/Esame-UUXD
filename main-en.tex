...
\definecolor{accentPurple}{HTML}{7C3AED}  % Purple â€” solweb.tper.it
\definecolor{accentViolet}{HTML}{8B5CF6}  % Violet â€” Punti Tper
\definecolor{accentTeal}{HTML}{0D9488}    % Teal â€” Tabaccherie
...
% ================================================================
% TEAM CARD â€” Valid for the entire project
% ================================================================
\section*{Team Card}
...
(\texttt{solweb.tper.it}): purchase and renewal of subscriptions
...
\noindent\textit{Analysis conducted according to UserFocus guidelines (\url{http://www.userfocus.co.uk/resources/guidelines.html}). For each issue, the violated guideline and its location in the system is indicated}
...
\noindent\textbf{Issue D2 â€” Violation G3}\phantomsection\label{iss:D2}\\
...
\noindent\textbf{Issue D3 â€” Violation G6, G10}\phantomsection\label{iss:D3}\\
\textit{Location: site â€” labels, buttons, system messages}\\
...
\noindent\textbf{Issue D4 â€” Violation G9}\phantomsection\label{iss:D4}\\
...
\noindent\textbf{Issue D5 â€” Violation G4}\phantomsection\label{iss:D5}\\
...
\noindent\textbf{Issue R1 â€” Guideline G5 (Trust and Credibility)}\phantomsection\label{iss:R1}\\
\textit{Location: solweb.tper.it â€” purchase and online payment area}\\
...
\noindent\textbf{Issue R2 â€” Guideline G8 (Search)}\phantomsection\label{iss:R2}\\
\textit{Location: tper.it site â€” internal search function}\\
...
\noindent\textbf{Issue R3 â€” Guideline G10 (Accessibility)}\phantomsection\label{iss:R3}\\
\textit{Location: tper.it site â€” texts, contrast, clickable areas}\\
...
\noindent\textbf{Issue R4 â€” Guideline G2 (Task Orientation)}\phantomsection\label{iss:R4}\\
...
\noindent\textbf{Issue R5 â€” Guideline G9 (Help, Feedback, Error
Tolerance)}\phantomsection\label{iss:R5}\\
\textit{Location: TPER ecosystem â€” absence of contextual
...
\textbf{This is the competitorâ€™s tool}\\
...
\noindent\textit{Analysis conducted according to UserFocus guidelines (\url{http://www.userfocus.co.uk/resources/guidelines.html}). For each problem, the violated guideline, its location in the system, and the severity classification are indicated.}
...
\noindent\textbf{Issue D1 â€” Violazione G1, G7}\phantomsection\label{atac:D1}\\
...
\noindent\textbf{Issue D2 â€” Violation G3}\phantomsection\label{atac:D2}\\
...
\noindent\textbf{Issue D3 â€” Violation G6, G10}\phantomsection\label{atac:D3}\\
...
\noindent\textbf{Issue D4 â€” Violation G9}\phantomsection\label{atac:D4}\\
...
\noindent\textbf{Issue D5 â€” Violation G4}\phantomsection\label{atac:D5}\\
...
\noindent\textbf{Issue R3 â€” Violation G10}\phantomsection\label{atac:R3}\\
...
\noindent\textbf{Issue R4 â€” Violation G2}\phantomsection\label{atac:R4}\\
...
\noindent\textbf{Issue R5 â€” Violation G9}\phantomsection\label{atac:R5}\\
...
% ================================================================
% PRELIMINARY USER TESTING CARD â€” Client's tool
% ================================================================
...
architecture, trainer modeÃƒÂ  authentication, accessibility, errorÃƒÂ 
...
\begin{itemize}
    ...
    assistance rarely leaves material with the user at the end of the
    session. The printable summary fills this gap and provides a
...
\begin{tcolorbox}[base]
    ...
    {\small
    \textbf{EtÃƒÂ :} 68 anni \hfill
    \textbf{Gender:} Female \hfill
    \textbf{NazionalitÃƒÂ :} Moroccan, resident in Italy for 22 years
    \\[2pt]
...
\begin{tcolorbox}[base]
    ...
    \begin{itemize}[leftmargin=*]
        \item \textbf{RF-05 --- ContinuitÃƒÂ  visiva tra piattaforme:}
        ...
        \item \textbf{RF-09 --- ModalitÃƒÂ  trainer con strumenti di guida:}
...
\begin{tcolorbox}[base]
    \textbf{Persona description} \\[4pt]
    {\small
    \textbf{EtÃƒÂ :} 79 years \hfill
    \textbf{Gender:} Female \hfill
    \textbf{NazionalitÃƒÂ :} Italiana \\[2pt]
    ...
    \textbf{Relevant physical issues:} Presbyopia (uses reading glasses), hand arthritis that reduces fine motor skillsÃƒÂ  fine, reduced mobilityÃƒÂ  (walks with a cane for long journeys). \\[2pt]
...
% ================================================================
% USE CASE #1: Ã‚Â«Il passaggio fantasmaÃ‚Â»
% ================================================================
...
% ================================================================
% USE CASE #2: Ã‚Â«L'architettura labirintoÃ‚Â»
% ================================================================
...
% ================================================================
% USE CASE #1: Ã‚Â«Il rinnovo che non si vedeÃ‚Â»
% ================================================================
...
\hline
\texttt{solweb.tper.it} & Digital & Online subscriptions, renewal, top-up, ISEE concessions & Web browser, requires account \\
\hline
...
\input{Comparison/00-reflections-body-en.tex}
...
--- Formative Test (2 subjects) \\
--- Summative Test (2 subjects)
\end{tabular} \\
\hline
\end{tabular}
